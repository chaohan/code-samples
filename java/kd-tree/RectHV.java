...
public class RectHV {
      ...
      /**
       * Unit tests the RectHV data type.
       */
      public static void main(String[] args) {
            RectHV my_rectangle = new RectHV(10.0,10.0,20.0,20.0);
            //my_rectangle.draw();
            Point2D pt = new Point2D(11.0,11.0);
            System.out.println(my_rectangle.contains(pt));
      }
